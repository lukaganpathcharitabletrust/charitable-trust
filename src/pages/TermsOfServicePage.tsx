...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50 py-16 px-4">
      <Helmet>
        <title>Terms of Service | Kai Luka Ganpathsheth Badgujar Charitable Trust</title>
        <meta name="description" content="Terms of service for the Kai Luka Ganpathsheth Badgujar Charitable Trust website. Please read these terms before using our services." />
        <link rel="canonical" href="https://lukaganpathcharitabletrust.in/terms" />
      </Helmet>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-6">
          <section>
            ...
            <p className="text-gray-700">
              At HopeCharity, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or make donations.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Information We Collect</h2>
            <p className="text-gray-700 mb-4">We collect information that you voluntarily provide to us when you:</p>
